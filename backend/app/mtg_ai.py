...
def new_illustration(image_desc: str) -> str:
    prompt = PromptTemplate(
        ...
        template="Generate a simple prompt to generate an image based on the following description: {image_desc}. Do not include any Cards or any text in the illustration.",
    )
...
def new_mtg_collection(theme:str) -> MtgCollectionModel:
    ...
    try:
        ...
        print(e)
    return MtgCollectionModel(**new_mtg_collection)
